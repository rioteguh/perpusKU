                ...
                <div class="col-lg-12 col-md-4 col-sm-6 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body table-responsive">
                            <button type="button" class="btn bg-light-blue waves-effect m-r-20" onclick="add_buku()"><i class="material-icons">person_add</i> Add Buku</button>
